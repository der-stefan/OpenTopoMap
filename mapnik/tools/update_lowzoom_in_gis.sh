...
# We can even replace de create table+insert into by one only line :
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS water (way geometry(Geometry,3857), name text, \"natural\" text, waterway text, way_area real);"
psql -d gis -c "INSERT INTO water SELECT * FROM  lowzoom_water;"
psql -d gis -c "CREATE INDEX IF NOT EXISTS water_way_idx ON water USING GIST (way);"
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS landuse (way geometry(Geometry,3857), landuse text, \"natural\" text);"
psql -d gis -c "INSERT INTO landuse SELECT * FROM  lowzoom_landuse;"
psql -d gis -c "CREATE INDEX IF NOT EXISTS landuse_way_idx ON landuse USING GIST (way);"
sleep 15	
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS roads (way geometry(LineString,3857), highway text, ref text);"
psql -d gis -c "INSERT INTO roads SELECT * FROM  lowzoom_roads;"
psql -d gis -c "CREATE INDEX IF NOT EXISTS roads_way_idx ON roads USING GIST (way);"
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS borders (way geometry(LineString,3857), boundary text, admin_level text);"
psql -d gis -c "INSERT INTO borders SELECT * FROM lowzoom_borders"
psql -d gis -c "CREATE INDEX IF NOT EXISTS borders_way_idx ON borders USING GIST (way);"
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS railways (way geometry(LineString,3857), railway text, \"service\" text, tunnel text);"
psql -d gis -c "INSERT INTO railways SELECT * FROM  lowzoom_railways;"
psql -d gis -c "CREATE INDEX IF NOT EXISTS railways_way_idx ON railways USING GIST (way);"
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS cities (way geometry(Point,3857), admin_level text, name text, capital text, place text, population integer);"
psql -d gis -c "INSERT INTO cities SELECT * FROM  lowzoom_cities;"
psql -d gis -c "CREATE INDEX IF NOT EXISTS cities_way_idx ON cities USING GIST (way);"
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS lakelabels (way geometry(LineString,3857), name text, label text, lake_area real);"
echo "lowzoom_lakelabel..."
psql -d gis -c "INSERT INTO lakelabels SELECT * FROM  lowzoom_lakelabel;"
echo "lowzoom_baylabel..."
psql -d gis -c "INSERT INTO lakelabels SELECT * FROM  lowzoom_baylabel;"
echo "lowzoom_straitplabel..."
psql -d gis -c "INSERT INTO lakelabels SELECT * FROM  lowzoom_straitplabel;"
echo "lowzoom_straitllabel..."
psql -d gis -c "INSERT INTO lakelabels SELECT * FROM  lowzoom_straitllabel;"
echo "lowzoom_glacierlabel..."
psql -d gis -c "INSERT INTO lakelabels SELECT * FROM  lowzoom_glacierlabel;"
echo "create index..."
psql -d gis -c "CREATE INDEX IF NOT EXISTS lakelabels_way_idx ON lakelabels USING GIST (way);"
...
psql -d gis -c "CREATE TABLE IF NOT EXISTS naturalarealabels (way geometry(LineString,3857), name text, areatype text, way_area real,nextregionsize real,subregionsize real);"
psql -d gis -c "INSERT INTO naturalarealabels SELECT * FROM  lowzoom_natural_areas;"
psql -d gis -c "INSERT INTO naturalarealabels SELECT * FROM  lowzoom_natural_lines;"
psql -d gis -c "CREATE INDEX IF NOT EXISTS naturalarealabels_way_idx ON naturalarealabels USING GIST (way);"
